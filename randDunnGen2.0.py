...
# Agenda:
    ...
    # Make user interface for customized
    # Far future:
...
MEGA_ROOMS = [POOL_SEED,SHAPE_SEED,[45,180,45,180]]
MINI_ROOMS = [POOL_SEED,SHAPE_SEED,[20,80,20,80]]
