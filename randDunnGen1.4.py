...
# Agenda:
    ...
    # Far future:
        ...
        # type in Minecraft
        # Add GUI so program can be run w/o using the python shell
        # and by simply opening the file
...
def collectStats(num=1,att=3): # Work in progress
    totRooms = 0
    totDoors = 0
    for i in range(num):
        myWin = GraphWin("My Dungeon",1500,750)
        ...
        myDun.close()
    print("The avg num of rooms per dungeon is:",totRooms/num)
